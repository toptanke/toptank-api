...
URL ```  https://api.toptank.top/v2/currency/trade/buy```
示例
```
# Request
GET   https://api.toptank.top/v2/currency/trade/buy
# Response
{
        "txNo":15300629835086
        "result":3000
...
URL ```   https://api.toptank.top/v2/currency/trade/sell```
示例
```
# Request
GET    https://api.toptank.top/v2/currency/trade/sell
# Response
{
...
URL ```https://api.toptank.top/v2/currency/trade/cancel```
示例
```
# Request
GET     https://api.toptank.top/v2/currency/trade/cancel
# Response
{
...
URL ```    https://api.toptank.top/v2/currency/trade/findOrder```
示例
```
# Request
GET     https://api.toptank.top/v2/currency/trade/findOrder
# Response
{
    "data":{
...
URL ```  https://api.toptank.top/v2/currency/trade/findEntrust ```
示例
```
# Request
GET https://api.toptank.top/v2/currency/trade/findEntrust
# Response
{
	"data":[{
	"createTimeString":2018-06-21 15:23:44
...
URL ```  https://api.toptank.top/v2/currency/trade/findHistoryEntrust```
示例
```
# Request
GET https://api.toptank.top/v2/currency/trade/findHistoryEntrust
# Response
{
	"data":[{
	"createTimeString":2018-06-21 15:23:44
...
URL ```https://api.toptank.top/v2/market/kline ```
示例
```
# Request
GET https://api.toptank.top/v2/market/kline
# Response
{
     "close":5715.99
     "high":5716.07
...
URL ```https://api.toptank.top/v2/market/alltickers```
示例
```
# Request
GET   https://api.toptank.top/v2/market/alltickers
# Response
{
    "ae_btc":{
        "date": 1542388520000
...
URL ```https://api.toptank.top/v2/market/tickers```
示例
```
# Request
GET   https://api.toptank.top/v2/market/tickers
# Response
{
    "date":1541738697723,
    "ticker":{
...
URL ```https://api.toptank.top/v2/market/trade```
示例
```
# Request
GET   https://api.toptank.top/v2/market/trade
# Response
{
     "amount":20.888
     "direction":
...
URL ```https://api.toptank.top/v2/member/getAccount```
示例
```
# Request
GET   https://api.toptank.top/v2/member/getAccount
# Response
{
     "blockedNum":0
